        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <h1 class="display-1 text-uppercase text-white mb-4">VINTAGE DELIGHT</h1>
                    <h1 class="font-secondary text-primary mb-4">We Create Delicious Memories</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                ...
                <h1 class="display-4 text-uppercase">Welcome To Vintage Delight</h1>
            </div>
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="<?php echo base_url().'assets/img/about.jpg';?>" style="object-fit: cover;">
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex">
                        ...
                        <div class="ps-4">
                            ...
                            <h1 class="display-5 text-white mb-0" data-toggle="counter-up">5</h1> <h3 class="text-white">Years</h3> 
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
...
@media only screen and (min-width: 819px) {
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <a href="#galleryModal" data-large-src ="<?php echo base_url().'assets/img/cake1.jpeg';?>" data-toggle ="modal">
                                        <img class="img-fluid img-thumbnail gallery-item" src="<?php echo base_url().'assets/img/cake1.jpeg';?>" alt="" style="width: 350px; height: 340px;">
                                        </a>
                                    </div>

                                   
                                    <div id="fadeshow1" class=" newflex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                    ...
                    <div id="tab-2" class="tab-pane fade show p-0">
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <img class="img-fluid" src="img/cake-2.jpg" alt="" style="width: 350px; height: 340px;">
                    ...
                    <div id="tab-3" class="tab-pane fade show p-0">
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <img class="img-fluid" src="img/cake-3.jpg" alt="" style="width: 350px; height: 340px;">
                                        <h4 class="bg-dark text-primary p-2 m-0">$99.00</h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                   ...
                   <div class="col-lg-4 col-md-6">
                       <div class="team-item">
                           <div class="position-relative overflow-hidden">
                               <img class="img-fluid w-100" src="<?php echo base_url().'assets/img/cake1.jpeg';?>" alt="">
                               <div class="team-overlay w-100 h-100 position-absolute top-50 start-50 translate-middle d-flex align-items-center justify-content-center">
                                   <div class="d-flex align-items-center justify-content-start">
                                       <a class="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 mx-1" href="#"><i class="fab fa-instagram fw-normal"></i></a>
                                       <a class="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 mx-1" href="#"><i class="fab fa-facebook-f fw-normal"></i></a>
                                    <a class="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 mx-1" href="#"><i class="fab fa-whatsapp fw-normal"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="bg-dark border-inner text-center p-4">
                            <h4 class="text-uppercase text-primary">Neha Rede</h4>
                            <p class="text-white m-0">Bakester</p>
                        </div>
                    </div>
                </div>
            </center> 
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Birthday Cakes</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
         <img src="<?php echo base_url().'assets/img/cake1.jpeg';?>" class="modal-img" alt="modal img">
      </div>
    </div>
  </div>
</div>
